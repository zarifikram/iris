...
class Trainer:
    ...
    def train_agent(self, epoch: int) -> None:
        ...
        if epoch > cfg_actor_critic.start_after_epochs:
            metrics_actor_critic = self.train_component(self.agent.actor_critic, self.optimizer_actor_critic, sequence_length=1 + self.cfg.training.actor_critic.burn_in, sample_from_start=False, frame_embedder=self.agent.frame_embedder, sequence_embedder=self.agent.sequence_embedder, **cfg_actor_critic)
